...
function sumAndMultiply(a, b, c) { //eslint-disable-line
  var threeSum = sum(a, sum(b, c)[0])[0];
  var threeMult = multiply(multiply(a, b)[0], c)[0];

  var sumMessage = a + ' and ' + b + ' and ' + c + ' sum to ' + threeSum + '.';
  var multMessage = 'The product of ' + a + ' and ' + b + ' and ' + c + ' is ' + threeMult + '.';

  return [threeSum, threeMult, sumMessage, multMessage];
}
...
function multiplyArray(testArray) { //eslint-disable-line
  var arrayProduct = 0;
  arrayProduct = multiply(testArray[0], multiply(testArray[1], testArray[2])[0])[0];

  var message = 'The numbers ' + testArray + ' have a product of ' + arrayProduct + '.';
  console.log(message);   // debugging
